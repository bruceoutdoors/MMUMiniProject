...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`USER` (
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`LECTURER` (
  `user_id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`STUDENT` (
  `user_id` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`ADMIN` (
  `user_id` INT(11) NOT NULL,
  `USER_user_id` INT(11) NOT NULL,
  PRIMARY KEY (`user_id`),
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`FACULTY` (
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`SPECIALIZATION` (
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`PROJECT` (
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`COMMENT` (
...
CREATE TABLE IF NOT EXISTS `mmuminiproject`.`ROLE` (
